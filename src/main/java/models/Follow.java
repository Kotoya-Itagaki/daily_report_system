...
@NamedQueries({
    @NamedQuery(
            name = JpaConst.Q_FOL_GET_REPORT_BY_FOLLOW,
            query = JpaConst.Q_FOL_GET_REPORT_BY_FOLLOW_DEF),
    @NamedQuery(
            name = JpaConst.Q_FOL_COUNT_REPORT_BY_FOLLOW,
            query = JpaConst.Q_FOL_COUNT_REPORT_BY_FOLLOW_DEF),
    @NamedQuery(
            name = JpaConst.Q_FOL_COUNT_RESISTERED,
            query = JpaConst.Q_FOL_COUNT_RESISTERED_DEF)
})
...
public class Follow {
    ...
    private Employee employeeFollower;
